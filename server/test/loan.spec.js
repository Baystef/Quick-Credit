...
describe('LOANS route', () => {
        ...
        .end((loginerr, loginres) => {
          ...
          chai
            ...
            .end((err, res) => {
              ...
              expect(res.body).to.be.a('object');
              expect(res.body.data.userMail).to.exist;
  ...
  describe('LOAN STATUS UPDATE route', () => {
    ...
    it('should return 201 and repay a current approved loan', (done) => {
      const user = {
        email: 'admin@quickcredit.com',
        password: 'quickcreditsecret10',
      };
      chai
        ...
        .end((loginerr, loginres) => {
          const token = `Bearer ${loginres.body.data.token}`;
          const paidAmount = { paidAmount: 105000 };
          chai
            .request(server)
            ...
            .end((err, res) => {
              ...
              expect(res.body.data.amount).to.exist;
